...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (int i = 1; i <= 10 * Math.random(); i++) {
            LatLng loc = new LatLng(Math.random() * i * 100, Math.random() * i * 100);
            mMap.addMarker(new MarkerOptions().position(loc).title("Marker in loc" + i));
        }
    }
